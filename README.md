...
| `CMakeTargetsFile` | Operations to configure binary targets using a JSON configuration file ([more details](https://josephgarnier.github.io/cmake-modules-collection/module/CMakeTargetsFile.html)) | `cmake/modules/CMakeTargetsFile.cmake` |
