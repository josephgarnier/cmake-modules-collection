...
function(${CMAKETEST_TEST})
	...
	ct_add_section(NAME "strip_interfaces_output_version")
	function(${CMAKETEST_SECTION})
		set(input "libA;$<BUILD_INTERFACE:src>;libB;libC;$<INSTALL_INTERFACE:include/>libD")
		unset(output)
	...
	ct_add_section(NAME "strip_nothing_no_interfaces_detected_output_version")
	function(${CMAKETEST_SECTION})
		set(input "libA;libB")
		unset(output)
		string_manip(STRIP_INTERFACES input OUTPUT_VARIABLE output)
	...
	ct_add_section(NAME "strip_all_when_only_interfaces_detected_output_version")
	function(${CMAKETEST_SECTION})
		set(input "$<BUILD_INTERFACE:src>;$<INSTALL_INTERFACE:include/>")
		unset(output)
		string_manip(STRIP_INTERFACES input OUTPUT_VARIABLE output)
	...
	function(${CMAKETEST_SECTION})
		string_manip(STRIP_INTERFACES "foo")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		set(input "mystring")
		string_manip(STRIP_INTERFACES input OUTPUT_VARIABLE "foo")
	endfunction()
