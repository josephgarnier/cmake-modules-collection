...
function(${CMAKETEST_TEST})
  ...
  function(${CMAKETEST_SECTION})
    ...
    set(expected_result
      ...
      "${TESTS_DATA_DIR}/src/main.cpp"
      "${TESTS_DATA_DIR}/src")
    file_manip(ABSOLUTE_PATH input_mixed_paths BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}")
  ...
  function(${CMAKETEST_SECTION})
    ...
    set(expected_result
      ...
      "${TESTS_DATA_DIR}/src")
    unset(output)
    file_manip(ABSOLUTE_PATH input_mixed_paths BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}" OUTPUT_VARIABLE output)
  ...
  function(${CMAKETEST_SECTION})
    set(input "../data/fake/directory/file.cpp")
    file_manip(ABSOLUTE_PATH input BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}")
  endfunction()
  ...
  ct_add_section(NAME "throws_if_arg_base_dir_does_not_exist" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    set(input "../data/src/main.cpp")
  ...
  function(${CMAKETEST_SECTION})
    set(input "../data/src/main.cpp")
    file_manip(ABSOLUTE_PATH input BASE_DIR "../data")
  endfunction()
