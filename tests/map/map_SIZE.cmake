...
function(${CMAKETEST_TEST})
  ...
  ct_add_section(NAME "get_size_of_map_with_various_keys")
  function(${CMAKETEST_SECTION})
    map(SIZE input_map map_size)
    list(LENGTH input_map input_map_len)
    ct_assert_equal(input_map_len 12)
    ct_assert_string(map_size)
    ct_assert_equal(map_size 10)
  endfunction()

  ct_add_section(NAME "get_size_of_empty_map")
  function(${CMAKETEST_SECTION})
    set(input_map "")
    map(SIZE input_map map_size)
    list(LENGTH input_map input_map_len)
    ct_assert_equal(input_map_len 0)
    ct_assert_string(map_size)
    ct_assert_equal(map_size 0)
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    map(SIZE input_map map_size "too" "many" "args")
  endfunction()
