...
#-------------------------------------------------------------------------------
# Test of [Map module::ADD operation]:
#    map(ADD <map-var> <key> <value>)
ct_add_test(NAME "test_map_add_operation")
function(${CMAKETEST_TEST})
  ...
  ct_add_section(NAME "add_to_existing_key")
  function(${CMAKETEST_SECTION})
    ...
    map(ADD copy_of_input_map "entry 6" "peach")
    ...
    map(ADD copy_of_input_map "entry 6" "blueberry:blackberry")
    ct_assert_list(copy_of_input_map)
    ct_assert_equal(copy_of_input_map "${expected_result}")
    ...
    map(ADD copy_of_input_map "entry 6" "")
    ct_assert_list(copy_of_input_map)
    ct_assert_equal(copy_of_input_map "${expected_result}")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    map(ADD copy_of_input_map "entry 11" "peach")
    ct_assert_list(copy_of_input_map)
    ct_assert_equal(copy_of_input_map "${expected_result}")
    ...
    map(ADD copy_of_input_map "entry 12" "")
    ct_assert_list(copy_of_input_map)
    ct_assert_equal(copy_of_input_map "${expected_result}")
  endfunction()

  ct_add_section(NAME "add_to_invalide_key")
  function(${CMAKETEST_SECTION})
    # Add full value
    set(copy_of_input_map "${input_map}")
    set(expected_result
    ...
    map(ADD copy_of_input_map "invalid" "peach")
    ct_assert_list(copy_of_input_map)
    ct_assert_equal(copy_of_input_map "${expected_result}")
    ...
    map(ADD copy_of_input_map "invalid" "")
    ct_assert_list(copy_of_input_map)
    ct_assert_equal(copy_of_input_map "${expected_result}")
  endfunction()

  ct_add_section(NAME "add_in_empty_map")
  function(${CMAKETEST_SECTION})
    # Add full value
    set(input_map "")
    set(expected_result "entry 6:peach")
    map(ADD input_map "entry 6" "peach")
    ct_assert_equal(input_map "${expected_result}")
    
    # Add empty value
    set(input_map "")
    set(expected_result "entry 6:")
    map(ADD input_map "entry 6" "")
    ct_assert_equal(input_map "${expected_result}")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    map(ADD input_map "entry 6" "peach" "too" "many" "args")
  endfunction()

  ct_add_section(NAME "throws_if_arg_map_var_is_missing_1" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    map(ADD "entry 6" "peach")
  endfunction()
