...
function(${CMAKETEST_TEST})
  ...
  function(${CMAKETEST_SECTION})
    ...
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.minVersion")
    ct_assert_equal(output "1.15.0")
    
    # Get boolean values
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.fetchInfo.autodownload")
    ct_assert_true(output)
    ct_assert_equal(output "ON")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.optional")
  ...
  function(${CMAKETEST_SECTION})
    ...
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.configuration.compileFeatures")
    ct_assert_equal(output "cxx_std_20")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.configuration.compileDefinitions")
    ct_assert_equal(output "DEFINE_ONE=1")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.configuration.compileOptions")
    ct_assert_equal(output "-Wall")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.configuration.linkOptions")
