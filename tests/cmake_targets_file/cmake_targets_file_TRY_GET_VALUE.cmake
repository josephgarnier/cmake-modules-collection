...
function(${CMAKETEST_TEST})
  ...
  function(${CMAKETEST_SECTION})
    ...
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.build.compileFeatures")
    ct_assert_equal(output "cxx_std_20")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.build.compileDefinitions")
    ct_assert_equal(output "DEFINE_ONE=1")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.build.compileOptions")
    ct_assert_equal(output "-Wall")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies.AppleLib.build.linkOptions")
