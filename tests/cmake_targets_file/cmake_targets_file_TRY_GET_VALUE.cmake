...
function(${CMAKETEST_TEST})
  ...
  function(${CMAKETEST_SECTION})
    ...
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "rulesFile")
    ct_assert_equal(output "generic")
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "minVersion")
    ct_assert_equal(output "1.15.0")
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "integrationMethod")
    ct_assert_equal(output "FIND_THEN_FETCH")
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "packageLocation.windows")
    ct_assert_equal(output "C:/Program Files/libs/apple/1.15.0")
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "downloadInfo.tag")
    ct_assert_equal(output "1234567")

    # Get some boolean values
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "optional")
    ct_assert_equal(output "OFF")

    # Not number values to get

    # Get some arrays
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "build.compileFeatures")
    ct_assert_equal(output "cxx_std_20")

    # Get from non-existent key
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "fake")
    ct_assert_equal(output "fake-NOTFOUND")
    ct_assert_false(output) # equals to "fake-NOTFOUND"

    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "fake.key")
    ct_assert_equal(output "fake.key-NOTFOUND")
    ct_assert_false(output) # equals to "fake.key-NOTFOUND"

    # Get invalid key
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY "invalid")
  ...
  function(${CMAKETEST_SECTION})
    ...
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "dependencies")
    ct_assert_list(output)
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE TARGET "src" KEY "name")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output KEY "rulesFile")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output DEP KEY "rulesFile")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output TARGET KEY "name")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" TARGET "src" KEY "name")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    function(${CMAKETEST_SECTION})
      ...
      function(${CMAKETEST_SECTION})
        cmake_targets_file(TRY_GET_VALUE output DEP "BananaLib" KEY "rulesFile")
      endfunction()

      ct_add_section(NAME "throws_if_global_property_is_different_target_inner_2" EXPECTFAIL)
      function(${CMAKETEST_SECTION})
        cmake_targets_file(TRY_GET_VALUE output TARGET "src/grape" KEY "name")
      endfunction()
    endfunction()
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output DEP "AppleLib" KEY)
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY)
  endfunction()
