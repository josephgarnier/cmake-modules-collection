...
function(${CMAKETEST_TEST})
  ...
  function(${CMAKETEST_SECTION})
    ...
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "extDependencies.AppleLib.minVersion")
  ...
  function(${CMAKETEST_SECTION})
    ...
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "extDependencies")
    ct_assert_list(output)
    ...
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "extDependencies.AppleLib.build.compileFeatures")
    ct_assert_equal(output "cxx_std_20")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "extDependencies.AppleLib.build.compileDefinitions")
    ct_assert_equal(output "DEFINE_ONE=1")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "extDependencies.AppleLib.build.compileOptions")
    ct_assert_equal(output "-Wall")
    cmake_targets_file(TRY_GET_VALUE output TARGET "src" KEY "extDependencies.AppleLib.build.linkOptions")
