...
#-------------------------------------------------------------------------------
# Test of [CMakeTargetsFile module::GET_SETTING_VALUE operation]:
#    cmake_targets_file(GET_SETTING_VALUE <output-var> TARGET <target-dir-path> KEY <setting-name>)
ct_add_test(NAME "test_cmake_targets_file_op_get_setting_value")
function(${CMAKETEST_TEST})
	...
	macro(_set_up_test)
		# Reset properties used by `cmake_targets_file(GET_SETTING_VALUE)`
	...
	function(${CMAKETEST_SECTION})
		...
		# Get a simple value
		cmake_targets_file(GET_SETTING_VALUE output TARGET "src" KEY "name")
		...
		cmake_targets_file(GET_SETTING_VALUE output TARGET "src" KEY "build.compileDefinitions")
	...
	function(${CMAKETEST_SECTION})
		...
		set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED "on")
		set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_config_map}")
		cmake_targets_file(GET_SETTING_VALUE TARGET "src" KEY "name")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED "on")
		set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_config_map}")
		cmake_targets_file(GET_SETTING_VALUE output KEY "name")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED "on")
		set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_config_map}")
		cmake_targets_file(GET_SETTING_VALUE output TARGET KEY "name")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		function(${CMAKETEST_SECTION})
			...
			function(${CMAKETEST_SECTION})
				cmake_targets_file(GET_SETTING_VALUE output TARGET "src/apple" KEY "name")
			endfunction()
		endfunction()
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED "on")
		set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_config_map}")
		cmake_targets_file(GET_SETTING_VALUE output TARGET "src")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED "on")
		set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_config_map}")
		cmake_targets_file(GET_SETTING_VALUE output TARGET "src" KEY)
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED "on")
		set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_config_map}")
		cmake_targets_file(GET_SETTING_VALUE output TARGET "src" KEY "fake.key")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED "on")
		set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_config_map}")
		cmake_targets_file(GET_SETTING_VALUE output TARGET "src" KEY "invalid")
	endfunction()
