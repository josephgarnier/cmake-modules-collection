...
function(${CMAKETEST_TEST})
  ...
  ct_add_section(NAME "get_keys_from_dep_config")
  function(${CMAKETEST_SECTION})
    ...
    function(${CMAKETEST_SECTION})
      ...
      cmake_targets_file(GET_KEYS output DEP "AppleLib")
    ...
    function(${CMAKETEST_SECTION})
      ...
      set(expected_output
        ...
        "minVersion"
        "integrationMethod"
        "packageLocation.windows"
        "packageLocation.unix"
        "packageLocation.macos"
        "downloadInfo.kind"
        "downloadInfo.repository"
        "downloadInfo.tag"
  ...
  ct_add_section(NAME "get_keys_from_target_config")
  function(${CMAKETEST_SECTION})
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(GET_KEYS output DEP)
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_DEP_AppleLib" "${input_apple_dep_config}")
    set_property(GLOBAL PROPERTY "TARGETS_CONFIG_src" "${input_src_config}")
    cmake_targets_file(GET_KEYS output DEP "AppleLib" TARGET "src")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    ...
    function(${CMAKETEST_SECTION})
      ...
      function(${CMAKETEST_SECTION})
        cmake_targets_file(GET_KEYS output DEP "BananaLib")
      endfunction()
