...
function(${CMAKETEST_TEST})
  ...
  function(${CMAKETEST_SECTION})
    _validate_json_string(PROP_PATH "one;two;three" PROP_VALUE "banana" MIN_LENGTH "true")
  endfunction()

  ct_add_section(NAME "throws_if_arg_min_length_is_boolean_2" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    _validate_json_string(PROP_PATH "one;two;three" PROP_VALUE "banana" MIN_LENGTH "false")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    _validate_json_string(PROP_PATH "one;two;three" PROP_VALUE "banana" MAX_LENGTH "true")
  endfunction()

  ct_add_section(NAME "throws_if_arg_max_length_is_boolean_2" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    _validate_json_string(PROP_PATH "one;two;three" PROP_VALUE "banana" MAX_LENGTH "false")
  endfunction()
