...
function(${CMAKETEST_TEST})
  ...
  ct_add_section(NAME "check_when_global_property_is_true")
  ...
  ct_add_section(NAME "check_when_global_property_is_false")
  function(${CMAKETEST_SECTION})
    _set_up_test()
    set_property(GLOBAL PROPERTY TARGETS_CONFIG_LOADED false)

    ct_add_section(NAME "check_when_global_property_is_false_inner" EXPECTFAIL)
    function(${CMAKETEST_SECTION})
      _assert_config_file_loaded()
    endfunction()
  endfunction()
