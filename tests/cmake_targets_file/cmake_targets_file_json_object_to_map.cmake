...
#   _json_object_to_map(<json-object> <output-map-var>)
...
[=[tropical mix:{
  ...
  [
    ...
    _json_object_to_map("${input_json_object}" output)
  ...
  function(${CMAKETEST_SECTION})
    _json_object_to_map("${input_json_object}" output "too" "many" "args")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    _json_object_to_map("invalid json" output)
  endfunction()
