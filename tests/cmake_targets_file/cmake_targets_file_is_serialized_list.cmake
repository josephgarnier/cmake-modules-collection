...
#    _is_serialized_list(<output-var> <input-list>)
...
function(${CMAKETEST_TEST})
  ...
  function(${CMAKETEST_SECTION})
    _is_serialized_list(is_serialized "apple" "too" "many" "args")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    _is_serialized_list("is_serialized" "apple")
  endfunction()
  ...
  ct_add_section(NAME "throws_if_arg_intput_string_is_a_cmake_list" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    _is_serialized_list(is_serialized "apple")
  endfunction()
endfunction()
