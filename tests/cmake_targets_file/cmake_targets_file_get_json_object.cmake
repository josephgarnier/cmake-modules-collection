...
[=[vegetables:[ "carrot", "cucumber" ]]=]
      ...
      _get_json_object("${input_json_object}" "fruit salad" true output)
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "smoothie;info" true output)
      ct_assert_list(output)
      ct_assert_equal(output "${expected_output}")
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "tropical mix;variants;0" true output)
      ct_assert_list(output)
      ct_assert_equal(output "${expected_output}")
    endfunction()
...
[=[tropical mix:{
  ...
  [
    ...
    },
    {
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "" true output)
      ct_assert_list(output)
      ct_assert_equal(output "${expected_output}")
    endfunction()
...
[=[vegetables:[ "carrot", "cucumber" ]]=]
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "fruit salad" false output)
      ct_assert_list(output)
      ct_assert_equal(output "${expected_output}")
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "smoothie;info" false output)
      ct_assert_list(output)
      ct_assert_equal(output "${expected_output}")
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "tropical mix;variants;0" false output)
      ct_assert_list(output)
      ct_assert_equal(output "${expected_output}")
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "tropical mix;invalid" false output)
...
[=[tropical mix:{
  ...
  [
    ...
    },
    {
      ...
      string(JSON json_block_type TYPE "${input_json_object}")
      ct_assert_equal(json_block_type "OBJECT")
      _get_json_object("${input_json_object}" "" false output)
      ct_assert_list(output)
      ct_assert_equal(output "${expected_output}")
    endfunction()
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    _get_json_object("{}" "" false output)
    ct_assert_equal(output "")

    _get_json_object("{}" "" true output)
    ct_assert_equal(output "")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    _get_json_object("${input_json_object}" "" false output "too" "many" "args")
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    _get_json_object("invalid json" "" false output)
  endfunction()

  ct_add_section(NAME "throws_if_arg_json_block_is_not_a_json_object_2" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    _get_json_object("${input_json_object}" "fruit salad;fruits" false output)
  endfunction()
  ...
  function(${CMAKETEST_SECTION})
    _get_json_object("${input_json_object}" "invalid" false output)
  endfunction()

  ct_add_section(NAME "throws_if_arg_json_path_is_invalid_2" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    _get_json_object("${input_json_object}" "fruit salad;invalid" false output)
  endfunction()

    ct_add_section(NAME "throws_if_arg_is_required_is_missing" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    _get_json_object("${input_json_object}" "fruit salad;fruits")
  endfunction()

  ct_add_section(NAME "throws_if_arg_is_required_is_not_bool" EXPECTFAIL)
  function(${CMAKETEST_SECTION})
    _get_json_object("${input_json_object}" "fruit salad;fruits" "wrong")
  endfunction()
