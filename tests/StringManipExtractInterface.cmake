...
function(${CMAKETEST_TEST})
	...
	function(${CMAKETEST_SECTION})
		set(input "before;$<BUILD_INTERFACE:src/file-a.cpp;src/file-b.cpp;src/file-c.cpp>;between;$<INSTALL_INTERFACE:include/file-a.h;include/file-b.h;include/file-c.h>;after")
		string_manip(EXTRACT_INTERFACE input BUILD)
		ct_assert_list(input)
		ct_assert_equal(input "src/file-a.cpp;src/file-b.cpp;src/file-c.cpp")
	endfunction()

	ct_add_section(NAME "extract_build_interface_output_version")
	function(${CMAKETEST_SECTION})
		set(input "before;$<BUILD_INTERFACE:src/file-a.cpp;src/file-b.cpp;src/file-c.cpp>;between;$<INSTALL_INTERFACE:include/file-a.h;include/file-b.h;include/file-c.h>;after")
		unset(output)
		string_manip(EXTRACT_INTERFACE input BUILD OUTPUT_VARIABLE output)
		ct_assert_equal(input "before;$<BUILD_INTERFACE:src/file-a.cpp;src/file-b.cpp;src/file-c.cpp>;between;$<INSTALL_INTERFACE:include/file-a.h;include/file-b.h;include/file-c.h>;after")
		ct_assert_list(output)
		ct_assert_equal(output "src/file-a.cpp;src/file-b.cpp;src/file-c.cpp")
	endfunction()
	...
	ct_add_section(NAME "extract_install_interface_output_version")
	function(${CMAKETEST_SECTION})
		set(input "before;$<BUILD_INTERFACE:src/file-a.cpp;src/file-b.cpp;src/file-c.cpp>;between;$<INSTALL_INTERFACE:include/file-a.h;include/file-b.h;include/file-c.h>;after")
		unset(output)
	...
	ct_add_section(NAME "extract_nothing_build_interface_output_version")
	function(${CMAKETEST_SECTION})
		set(input "before;$<BUILD_INTERFACE:>;between;$<INSTALL_INTERFACE:include/file-a.h;include/file-b.h;include/file-c.h>;after")
		unset(output)
		string_manip(EXTRACT_INTERFACE input BUILD OUTPUT_VARIABLE output)
	...
	ct_add_section(NAME "extract_nothing_install_interface_output_version")
	function(${CMAKETEST_SECTION})
		set(input "before;$<BUILD_INTERFACE:src/file-a.cpp;src/file-b.cpp;src/file-c.cpp>;between;$<INSTALL_INTERFACE:>;after")
		unset(output)
		string_manip(EXTRACT_INTERFACE input INSTALL OUTPUT_VARIABLE output)
	...
	function(${CMAKETEST_SECTION})
		string_manip(EXTRACT_INTERFACE)
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		string_manip(EXTRACT_INTERFACE "foo")
	endfunction()
