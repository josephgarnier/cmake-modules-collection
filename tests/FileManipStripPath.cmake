...
function(${CMAKETEST_TEST})
	...
	function(${CMAKETEST_SECTION})
		...
		function(${CMAKETEST_SECTION})
			...
			set(input "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/data/src/main.cpp")
			file_manip(STRIP_PATH input BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}")
			ct_assert_string(input)
	...
	function(${CMAKETEST_SECTION})
		...
		ct_add_section(NAME "inplace_version")
		function(${CMAKETEST_SECTION})
			set(input "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/data/src/fake.cpp")
			file_manip(STRIP_PATH input BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}")
			ct_assert_string(input)
			ct_assert_equal(input "data/src/fake.cpp")
		endfunction()
		...
		function(${CMAKETEST_SECTION})
			...
			file_manip(STRIP_PATH input BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}" OUTPUT_VARIABLE output)
			ct_assert_string(output)
			ct_assert_equal(output "data/src/fake.cpp")
		endfunction()
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		...
		ct_add_section(NAME "inplace_version")
		function(${CMAKETEST_SECTION})
			set(input "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/fake/data/src/main.cpp")
	...
	function(${CMAKETEST_SECTION})
		...
		function(${CMAKETEST_SECTION})
			...
			file_manip(STRIP_PATH input BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/fake")
			ct_assert_string(input)
			ct_assert_equal(input "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/data/src/main.cpp")
		endfunction()
