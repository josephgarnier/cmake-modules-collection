...
#-------------------------------------------------------------------------------
# Test the StringManip module|SPLIT_TRANSFORM operation: ``string_manip(SPLIT_TRANSFORM <string_var> <ACTION> [OUTPUT_VARIABLE <output_var>])``
...
function(${CMAKETEST_TEST})
	...
	function(${CMAKETEST_SECTION})
		string_manip(SPLIT_TRANSFORM "foo")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		set(input "mystring")
		string_manip(SPLIT_TRANSFORM input OUTPUT_VARIABLE)
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		set(input "mystring")
		string_manip(SPLIT_TRANSFORM input OUTPUT_VARIABLE "foo")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		set(input "mystring")
		unset(output)
		string_manip(SPLIT_TRANSFORM input OUTPUT_VARIABLE output)
	endfunction()
endfunction()
