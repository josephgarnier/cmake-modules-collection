...
#-------------------------------------------------------------------------------
# Test of [BuildBinTarget module::ADD_PRECOMPILED_HEADER operation]:
#    build_bin_target(ADD_PRECOMPILED_HEADER <target-name> HEADER_FILE <file-path>)
ct_add_test(NAME "test_build_bin_target_add_precompiled_header_operation")
function(${CMAKETEST_TEST})
	...
	macro(_set_up_test)
		# Reset properties set by `build_bin_target(ADD_PRECOMPILED_HEADER)`
	...
	function(${CMAKETEST_SECTION})
		_set_up_test()
		build_bin_target(ADD_PRECOMPILED_HEADER "new_static_mock_lib" HEADER_FILE "${input_pch_header}")
		...
		build_bin_target(ADD_PRECOMPILED_HEADER "new_shared_mock_lib" HEADER_FILE "${input_pch_header}")
	...
	function(${CMAKETEST_SECTION})
		build_bin_target(ADD_PRECOMPILED_HEADER HEADER_FILE "${input_pch_header}")
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		build_bin_target(ADD_PRECOMPILED_HEADER "unknown_target" HEADER_FILE "${input_pch_header}")
	endfunction()

	ct_add_section(NAME "throws_if_arg_header_file_is_missing_1" EXPECTFAIL)
	function(${CMAKETEST_SECTION})
		build_bin_target(ADD_PRECOMPILED_HEADER "new_static_mock_lib")
	endfunction()

	ct_add_section(NAME "throws_if_arg_header_file_is_missing_2" EXPECTFAIL)
	function(${CMAKETEST_SECTION})
		build_bin_target(ADD_PRECOMPILED_HEADER "new_static_mock_lib" HEADER_FILE)
	endfunction()
	...
	function(${CMAKETEST_SECTION})
		build_bin_target(ADD_PRECOMPILED_HEADER "new_static_mock_lib" HEADER_FILE "data/src/not-exists.h")
	endfunction()
endfunction()
