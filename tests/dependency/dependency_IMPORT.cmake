...
#    ``dependency(IMPORT <lib-target-name> <STATIC|SHARED> [RELEASE_NAME <raw-filename>] [DEBUG_NAME <raw-filename>] ROOT_DIR <directory-path> INCLUDE_DIR <directory-path>)``
...
function(${CMAKETEST_TEST})
	...
	function(${CMAKETEST_SECTION})
		...
		get_property(output_lib_property TARGET "${lib_target_name}"
			PROPERTY IMPORTED_LOCATION_BUILD_${CMAKE_BUILD_TYPE} SET)
		ct_assert_true(output_lib_property)
		ct_assert_target_does_not_have_property("${lib_target_name}"
			IMPORTED_LOCATION_INSTALL_${CMAKE_BUILD_TYPE})
		get_property(output_lib_property TARGET "${lib_target_name}"
			PROPERTY IMPORTED_LOCATION_INSTALL_${CMAKE_BUILD_TYPE} SET)
		ct_assert_true(output_lib_property)
		ct_assert_target_does_not_have_property("${lib_target_name}"
		...
		ct_assert_true(output_lib_property)
		get_target_property(output_lib_property "${lib_target_name}"
			IMPORTED_SONAME_${CMAKE_BUILD_TYPE})
