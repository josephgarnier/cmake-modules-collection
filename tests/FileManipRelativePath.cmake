...
function(${CMAKETEST_TEST})
	...
	function(${CMAKETEST_SECTION})
		set(input "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/data/src/main.cpp")
		file_manip(RELATIVE_PATH input BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/data/src/source_1.cpp")
	endfunction()

	ct_add_section(NAME "throws_if_input_file_does_not_exists" EXPECTFAIL)
	function(${CMAKETEST_SECTION})
		set(input "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/data/src/not-exists.cpp")
		file_manip(RELATIVE_PATH input BASE_DIR "${CMAKE_CURRENT_FUNCTION_LIST_DIR}")
	endfunction()
