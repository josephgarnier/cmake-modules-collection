...
macro(_map_size)
	...
	foreach(entry IN ITEMS ${map_content})
		_validate_map_entry("${entry}" entry_key entry_is_valid)
...
macro(_map_set)
	...
	foreach(i RANGE 0 ${last_index})
		...
		if("${entry_key}" STREQUAL "${new_key}")
			list(SET map_content ${i} "${new_entry}")
			set(key_is_found on)
			break()
		endif()
	endforeach()
...
#------------------------------------------------------------------------------
# Internal usage
function(_validate_map_entry entry output_key_var output_is_valid_var)
	set(entry_key "")
