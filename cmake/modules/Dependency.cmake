...
#------------------------------------------------------------------------------
# [Internal use only]
function(_generate_import_header_code in_out_var)
  if(NOT ${ARGC} EQUAL 1)
    message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION}() requires exactly 1 arguments, got ${ARGC}!")
  endif()
  if("${in_out_var}" STREQUAL "")
    message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION}() requires 'in_out_var' to be a non-empty string value!")
  endif()

  string(APPEND ${in_out_var}
...
"
  ...
  return(PROPAGATE "${in_out_var}")
endfunction()

#------------------------------------------------------------------------------
# [Internal use only]
function(_generate_import_from_build_tree lib_target_name in_out_var)
  if(NOT ${ARGC} EQUAL 2)
  ...
  if("${in_out_var}" STREQUAL "")
    message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION}() requires 'in_out_var' argument to be a non-empty string value!")
  endif()
...
#------------------------------------------------------------------------------
# [Internal use only]
function(_generate_import_from_install_tree relative_export_dir_path lib_target_name in_out_var)
  if(NOT ${ARGC} EQUAL 3)
...
#------------------------------------------------------------------------------
# [Internal use only]
function(_generate_import_footer_code in_out_var)
  if(NOT ${ARGC} EQUAL 1)
    message(FATAL_ERROR "${CMAKE_CURRENT_FUNCTION}() requires exactly 1 arguments, got ${ARGC}!")
  endif()
  if("${in_out_var}" STREQUAL "")
