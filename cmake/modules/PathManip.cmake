...
function(path_manip)
  ...
  elseif((DEFINED arg_GET_COMPONENT)
    ...
    elseif("${arg_MODE}" STREQUAL NAME)
      ...
      message(FATAL_ERROR "path_manip(GET_COMPONENT) requires a MODE to be specified!")
    endif()
  else()
...
macro(_path_manip_strip_path)
  ...
  if("${arg_STRIP_PATH}" STREQUAL "")
    message(FATAL_ERROR "path_manip(STRIP_PATH) requires STRIP_PATH to be a non-empty string!")
  endif()
  if(NOT DEFINED arg_BASE_DIR)
    message(FATAL_ERROR "path_manip(STRIP_PATH) requires the keyword BASE_DIR to be provided!")
  endif()
  if("${arg_BASE_DIR}" STREQUAL "")
    message(FATAL_ERROR "path_manip(STRIP_PATH) requires BASE_DIR to be a non-empty string!")
  endif()
...
macro(_path_manip_get_component_directory)
  ...
  if(NOT DEFINED arg_MODE)
    message(FATAL_ERROR "path_manip(GET_COMPONENT) requires the keyword MODE to be provided!")
  endif()
  if(NOT "${arg_MODE}" STREQUAL DIRECTORY)
    message(FATAL_ERROR "path_manip(GET_COMPONENT) requires MODE to have the value 'DIRECTORY'!")
  endif()
  if(NOT DEFINED arg_OUTPUT_VARIABLE)
    message(FATAL_ERROR "path_manip(GET_COMPONENT) requires the keyword OUTPUT_VARIABLE to be provided!")
  endif()
  if("${arg_OUTPUT_VARIABLE}" STREQUAL "")
    message(FATAL_ERROR "path_manip(GET_COMPONENT) requires OUTPUT_VARIABLE to be a non-empty string!")
  endif()
...
macro(_path_manip_get_component_name)
  ...
  if(NOT "${arg_MODE}" STREQUAL NAME)
    message(FATAL_ERROR "path_manip(GET_COMPONENT) requires MODE to have the value 'NAME'!")
  endif()
  if(NOT DEFINED arg_OUTPUT_VARIABLE)
    message(FATAL_ERROR "path_manip(GET_COMPONENT) requires the keyword OUTPUT_VARIABLE to be provided!")
  endif()
